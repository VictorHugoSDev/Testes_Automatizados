package veterinario.exercicio.controller;
...
import veterinario.exercicio.services.VeterinarioService;
...
public class VeterinarioController {
    ...
    // Faz o mapeamento para a requisição find. Acessa o formulario de consulta de
    // veterinários
    @GetMapping("/find")
    ...
    // Faz o mapeamento para a requisição form. Acessa o formulario de cadastro de
    // animais
    @GetMapping("/form")
    ...
    // faz o mapeamento da requisição form com o parametro id. Acessa o formulario
    // de edição
    @GetMapping("form/{id}")
